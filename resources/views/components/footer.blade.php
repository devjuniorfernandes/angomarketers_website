...
<footer class="bg-slate-900 text-slate-300 border-t border-slate-800 font-sans mt-auto">
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8 py-12 md:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-4 flex flex-col space-y-4">
            ...
            <div class="flex items-center gap-3 pt-2">
                <!-- Facebook -->
                <a href="{{ $facebookUrl }}" target="_blank" class="w-8 h-8 rounded-lg bg-slate-800 hover:bg-primary hover:text-white transition-all duration-300 flex items-center justify-center text-slate-400">
                ...
                <a href="{{ $instagramUrl }}" target="_blank" class="w-8 h-8 rounded-lg bg-slate-800 hover:bg-primary hover:text-white transition-all duration-300 flex items-center justify-center text-slate-400">
                ...
                <!-- Linkedin -->
                <a href="{{ $linkedinUrl }}" target="_blank" class="w-8 h-8 rounded-lg bg-slate-800 hover:bg-primary hover:text-white transition-all duration-300 flex items-center justify-center text-slate-400">
        ...
        <div class="lg:col-span-2 flex flex-col space-y-3">
            ...
            <ul class="space-y-2 text-sm text-slate-400">
                ...
                <li><a href="{{ route('home') }}#newsletter-form" class="hover:text-primary transition-colors">WhatsApp Alertas</a></li>
            </ul>
        </div>
    ...
    <div class="border-t border-slate-800 py-6 text-center text-xs text-slate-500">
        <div class="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <span>&copy; {{ date('Y') }} AngoMarketers. Todos os direitos reservados. Feito em Angola.</span>
