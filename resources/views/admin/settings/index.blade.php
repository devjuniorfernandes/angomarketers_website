...
@section('title', 'Configurações do Sistema | AngoMarketers CMS')
    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 rounded-none space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="system_site_name" id="system_site_name" value="{{ old('system_site_name', $settings['system_site_name']) }}" required
                ...
                <div class="space-y-1">
                    ...
                    <input type="email" name="system_contact_email" id="system_contact_email" value="{{ old('system_contact_email', $settings['system_contact_email']) }}"
                           class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:border-primary">
                    @error('system_contact_email')
                        <p class="text-xs text-primary font-bold mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="system_contact_whatsapp" id="system_contact_whatsapp" value="{{ old('system_contact_whatsapp', $settings['system_contact_whatsapp']) }}"
                           class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:border-primary"
                           placeholder="Ex: +244923000000">
                    @error('system_contact_whatsapp')
                        <p class="text-xs text-primary font-bold mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-1 md:col-span-2">
                    ...
                    <textarea name="system_site_description" id="system_site_description" rows="3"
                              ...
                              placeholder="Breve descrição sobre o portal... (SEO)">{{ old('system_site_description', $settings['system_site_description']) }}</textarea>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4 border-t border-slate-100 dark:border-slate-800">
                ...
                <div class="space-y-1">
                    ...
                    <input type="text" name="system_facebook_url" id="system_facebook_url" value="{{ old('system_facebook_url', $settings['system_facebook_url']) }}"
                           class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:border-primary">
                </div>
                <!-- Instagram -->
                <div class="space-y-1">
                    ...
                    <input type="text" name="system_instagram_url" id="system_instagram_url" value="{{ old('system_instagram_url', $settings['system_instagram_url']) }}"
                           class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:border-primary">
                </div>
                <!-- LinkedIn -->
                <div class="space-y-1">
                    ...
                    <input type="text" name="system_linkedin_url" id="system_linkedin_url" value="{{ old('system_linkedin_url', $settings['system_linkedin_url']) }}"
                           class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:border-primary">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 rounded-none space-y-6">
            ...
            <div class="flex items-center gap-3">
                <input type="checkbox" name="homepage_video_show" id="homepage_video_show" value="1" {{ old('homepage_video_show', $settings['homepage_video_show']) == '1' ? 'checked' : '' }}
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="homepage_video_url" id="homepage_video_url" value="{{ old('homepage_video_url', $settings['homepage_video_url']) }}"
                       class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:border-primary"
                       placeholder="Ex: https://www.youtube.com/watch?v=GyxYCgc3jmM ou https://youtu.be/GyxYCgc3jmM">
                @error('homepage_video_url')
                    <p class="text-xs text-primary font-bold mt-1">{{ $message }}</p>
                @enderror
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 rounded-none space-y-8">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="checkbox" name="ad_super_billboard_show" id="ad_super_billboard_show" value="1" {{ old('ad_super_billboard_show', $settings['ad_super_billboard_show']) == '1' ? 'checked' : '' }}
                               class="w-4 h-4 accent-primary rounded-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        @if($settings['ad_super_billboard_image'])
                            <div class="mb-2">
                                <img src="{{ $settings['ad_super_billboard_image'] }}" alt="Super Billboard Banner" class="w-full max-h-24 object-cover border border-slate-200 dark:border-slate-800">
                            </div>
                        @endif
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="ad_super_billboard_url" id="ad_super_billboard_url" value="{{ old('ad_super_billboard_url', $settings['ad_super_billboard_url']) }}"
                               class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:border-primary"
            ...
            <div class="space-y-4 pt-6 border-t border-slate-100 dark:border-slate-800">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="checkbox" name="ad_slim_leaderboard_show" id="ad_slim_leaderboard_show" value="1" {{ old('ad_slim_leaderboard_show', $settings['ad_slim_leaderboard_show']) == '1' ? 'checked' : '' }}
                               class="w-4 h-4 accent-primary rounded-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="block text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Imagem do Banner</label>
                        @if($settings['ad_slim_leaderboard_image'])
                            <div class="mb-2">
                                <img src="{{ $settings['ad_slim_leaderboard_image'] }}" alt="Slim Leaderboard Banner" class="w-full max-h-24 object-cover border border-slate-200 dark:border-slate-800">
                            </div>
                        @endif
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="ad_slim_leaderboard_url" id="ad_slim_leaderboard_url" value="{{ old('ad_slim_leaderboard_url', $settings['ad_slim_leaderboard_url']) }}"
                               class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none text-slate-800 dark:text-slate-100 text-sm focus:outline-none focus:border-primary"
