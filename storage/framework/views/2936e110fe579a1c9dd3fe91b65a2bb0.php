<?php $__env->startSection('title', isset($sliderItem) ? 'Editar Slide | AngoMarketers CMS' : 'Novo Slide | AngoMarketers CMS'); ?>
<?php $__env->startSection('page_title', isset($sliderItem) ? 'Editar Slide' : 'Novo Slide'); ?>
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-800">
        <div>
            <h2 class="font-heading font-black text-xl text-slate-900 dark:text-white leading-tight">
                <?php echo e(isset($sliderItem) ? 'Editar Slide: ' . $sliderItem->title : 'Criar Novo Slide'); ?>
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 sm:p-8 rounded-none">
        <form action="<?php echo e(isset($sliderItem) ? route('admin.slider_items.update', $sliderItem) : route('admin.slider_items.store')); ?>" 
              method="POST" 
              enctype="multipart/form-data"
              class="space-y-6">
            <?php echo csrf_field(); ?>
            <?php if(isset($sliderItem)): ?>
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="title" id="title" value="<?php echo e(old('title', $sliderItem->title ?? '')); ?>" required autofocus
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <textarea name="subtitle" id="subtitle" rows="3"
                          ...
                          placeholder="Ex: Descubra as principais tendências de Marketing, Tecnologia, IA & Negócios."><?php echo e(old('subtitle', $sliderItem->subtitle ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="url" id="url" value="<?php echo e(old('url', $sliderItem->url ?? '')); ?>" required
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="space-y-1 md:col-span-2">
                    ...
                    <input type="text" name="badge" id="badge" value="<?php echo e(old('badge', $sliderItem->badge ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-1">
                    ...
                    <select name="badge_color" id="badge_color" required
                            class="w-full px-4 py-2 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none focus:outline-none focus:border-primary text-slate-800 dark:text-slate-100 text-sm transition-colors">
                        <option value="bg-primary" <?php echo e(old('badge_color', $sliderItem->badge_color ?? '') === 'bg-primary' ? 'selected' : ''); ?>>Vermelho (Principal)</option>
                        <option value="bg-slate-900" <?php echo e(old('badge_color', $sliderItem->badge_color ?? '') === 'bg-slate-900' ? 'selected' : ''); ?>>Preto/Slate</option>
                        <option value="bg-emerald-600" <?php echo e(old('badge_color', $sliderItem->badge_color ?? '') === 'bg-emerald-600' ? 'selected' : ''); ?>>Verde</option>
                        <option value="bg-blue-600" <?php echo e(old('badge_color', $sliderItem->badge_color ?? '') === 'bg-blue-600' ? 'selected' : ''); ?>>Azul</option>
                        <option value="bg-amber-500" <?php echo e(old('badge_color', $sliderItem->badge_color ?? '') === 'bg-amber-500' ? 'selected' : ''); ?>>Laranja</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="number" name="order" id="order" value="<?php echo e(old('order', $sliderItem->order ?? '0')); ?>" required min="0"
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-805 border border-slate-200 dark:border-slate-800 rounded-none focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary text-slate-800 dark:text-slate-100 text-sm transition-colors"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-2">
                <label for="image" class="block text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">
                    Imagem de Fundo do Slide <?php echo e(isset($sliderItem) ? '(Opcional)' : '*'); ?>

                </label>
                <?php if(isset($sliderItem->image_path)): ?>
                    <div class="flex items-center gap-4 mb-2">
                        <img src="<?php echo e($sliderItem->image_path); ?>" alt="Slide Atual" class="w-24 h-14 object-cover border border-slate-200 dark:border-slate-700">
                        <span class="text-xs text-slate-500">Imagem atual. Envie outra para substituir.</span>
                    </div>
                <?php endif; ?>
                <input type="file" name="image" id="image" <?php echo e(isset($sliderItem) ? '' : 'required'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-150 dark:border-slate-850">
                ...
                <button type="submit" 
                    ...
                    <?php echo e(isset($sliderItem) ? 'Guardar Alterações' : 'Criar Slide'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/utilizador/Desktop/BUILDINS/angomarketers/resources/views/admin/slider_items/form.blade.php ENDPATH**/ ?>