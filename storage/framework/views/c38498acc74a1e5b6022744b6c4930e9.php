        ...
        <div class="swiper-wrapper items-center">
            <?php $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="swiper-slide flex justify-center px-4">
                    <?php if($partner->url): ?>
                        <a href="<?php echo e($partner->url); ?>" target="_blank" class="block grayscale hover:grayscale-0 opacity-60 hover:opacity-100 transition-all duration-300">
                            <img src="<?php echo e($partner->logo_path); ?>" alt="<?php echo e($partner->name); ?>" class="h-10 max-w-[120px] object-contain">
                        </a>
                    <?php else: ?>
...
<?php /**PATH /Users/utilizador/Desktop/BUILDINS/angomarketers/resources/views/components/partner-slider.blade.php ENDPATH**/ ?>