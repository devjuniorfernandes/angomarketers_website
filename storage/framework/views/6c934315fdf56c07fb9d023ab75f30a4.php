<?php $__env->startSection('title', 'Categorias | AngoMarketers CMS'); ?>
<?php $__env->startSection('page_title', 'Gestão de Categorias'); ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-850/20">
                            ...
                            <td class="p-4 text-slate-655 dark:text-slate-400 text-xs leading-relaxed">
                                <?php echo e($category->description ?? 'Nenhuma descrição fornecida.'); ?>

                            </td>
                            <!-- Article Count -->
                            <td class="p-4 text-center font-bold text-slate-800 dark:text-slate-200">
                                <?php echo e($category->articles_count); ?>
                            ...
                            <td class="p-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <!-- Delete Button -->
                                    <form action="<?php echo e(route('admin.categories.destroy', $category)); ?>" method="POST" onsubmit="return confirm('Deseja realmente eliminar esta categoria?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/utilizador/Desktop/BUILDINS/angomarketers/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>