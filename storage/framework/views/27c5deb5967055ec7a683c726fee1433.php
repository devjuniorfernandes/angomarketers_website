<div <?php echo e($attributes->merge(['class' => 'p-6 bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl shadow-xs'])); ?>>
    ...
    <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" class="space-y-2.5">
        <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/utilizador/Desktop/BUILDINS/angomarketers/resources/views/components/newsletter-box.blade.php ENDPATH**/ ?>