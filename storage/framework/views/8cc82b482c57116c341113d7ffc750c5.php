<?php $__env->startSection('title', 'Tags | AngoMarketers CMS'); ?>
<?php $__env->startSection('page_title', 'Gestão de Tags'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4">
        <form action="<?php echo e(route('admin.tags.index')); ?>" method="GET" class="flex items-center gap-3">
            <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Pesquisar por nome de tag..."
            ...
            <?php if($search): ?>
                <a href="<?php echo e(route('admin.tags.index')); ?>" class="text-xs text-slate-400 hover:text-slate-200 underline">Limpar</a>
            <?php endif; ?>
        </form>
    </div>
                        ...
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-850/20">
                            ...
                            <td class="p-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="<?php echo e(route('admin.tags.destroy', $tag)); ?>" method="POST" onsubmit="return confirm('Deseja realmente eliminar esta tag?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/utilizador/Desktop/BUILDINS/angomarketers/resources/views/admin/tags/index.blade.php ENDPATH**/ ?>