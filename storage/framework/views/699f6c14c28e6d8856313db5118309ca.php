<?php $__env->startSection('title', 'Painel Geral | AngoMarketers CMS'); ?>
<?php $__env->startSection('page_title', 'Painel Geral'); ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-none flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-heading font-black text-slate-900 dark:text-white mt-1"><?php echo e($stats['articles_count']); ?></h3>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-none flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-heading font-black text-slate-900 dark:text-white mt-1"><?php echo e($stats['categories_count']); ?></h3>
            </div>
            <div class="p-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border border-slate-200/50 dark:border-slate-700/50">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-none flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-heading font-black text-slate-900 dark:text-white mt-1"><?php echo e($stats['events_count']); ?></h3>
            </div>
            <div class="p-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border border-slate-200/50 dark:border-slate-700/50">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-none flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-heading font-black text-slate-900 dark:text-white mt-1"><?php echo e($stats['trainings_count']); ?></h3>
            </div>
            <div class="p-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border border-slate-200/50 dark:border-slate-700/50">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-none flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-heading font-black text-slate-900 dark:text-white mt-1 <?php echo e($stats['pending_comments_count'] > 0 ? 'text-primary animate-pulse' : ''); ?>"><?php echo e($stats['pending_comments_count']); ?></h3>
            </div>
            <div class="p-2.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 border border-slate-200/50 dark:border-slate-700/50">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-none flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-heading font-black text-slate-900 dark:text-white mt-1"><?php echo e($stats['subscribers_count']); ?></h3>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-none flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-heading font-black text-slate-900 dark:text-white mt-1"><?php echo e($stats['visits_count']); ?></h3>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-none flex flex-col">
            <div class="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800 mb-4">
                ...
                <a href="<?php echo e(route('admin.articles.index')); ?>" class="text-xs font-bold text-primary hover:underline uppercase tracking-wider">Ver Todos</a>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800 text-sm">
                        <?php $__empty_1 = true; $__currentLoopData = $recentArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="py-3 pr-4 font-semibold text-slate-900 dark:text-white truncate max-w-[200px]" title="<?php echo e($article->title); ?>">
                                    <a href="<?php echo e(route('admin.articles.edit', $article)); ?>" class="hover:text-primary transition-colors">
                                ...
                                <td class="py-3 text-slate-500 dark:text-slate-400">
                                    <?php echo e($article->author->name ?? 'N/A'); ?>
        ...
        <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-none flex flex-col">
            <div class="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800 mb-4">
                ...
                <a href="<?php echo e(route('admin.comments.index')); ?>" class="text-xs font-bold text-primary hover:underline uppercase tracking-wider">Ver Todos</a>
            </div>
                    ...
                    <div class="border border-slate-100 dark:border-slate-800 p-4 bg-slate-50 dark:bg-slate-850 flex flex-col justify-between gap-3">
                        <div>
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-[10px] text-slate-400 dark:text-slate-500"><?php echo e($comment->created_at->diffForHumans()); ?></span>
                            </div>
                            ...
                            <p class="text-[10px] text-slate-400 dark:text-slate-500 mt-2">
                                Artigo: <span class="font-bold text-slate-500 dark:text-slate-400"><?php echo e($comment->article->title ?? 'Sem Artigo'); ?></span>
                            </p>
                        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="bg-slate-50 dark:bg-slate-850 p-5 border border-slate-100 dark:border-slate-800/80 rounded-2xl space-y-3">
                ...
                <div class="divide-y divide-slate-200/60 dark:divide-slate-800 text-xs">
                    <?php $__empty_1 = true; $__currentLoopData = $topArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $art): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="py-2.5 flex items-center justify-between gap-4">
                            <span class="font-medium text-slate-850 dark:text-slate-200 truncate" title="<?php echo e($art->title); ?>"><?php echo e($art->title); ?></span>
                            <span class="font-bold text-slate-500 shrink-0"><?php echo e($art->views_count); ?> views</span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="bg-slate-50 dark:bg-slate-850 p-5 border border-slate-100 dark:border-slate-800/80 rounded-2xl space-y-3">
                ...
                <div class="divide-y divide-slate-200/60 dark:divide-slate-800 text-xs">
                    <?php $__empty_1 = true; $__currentLoopData = $topEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="py-2.5 flex items-center justify-between gap-4">
                            <span class="font-medium text-slate-850 dark:text-slate-200 truncate" title="<?php echo e($evt->title); ?>"><?php echo e($evt->title); ?></span>
                            <span class="font-bold text-slate-500 shrink-0"><?php echo e($evt->views_count); ?> views</span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <span class="text-slate-400 block pt-2">Sem registo</span>
                    <?php endif; ?>
            ...
            <div class="bg-slate-50 dark:bg-slate-850 p-5 border border-slate-100 dark:border-slate-800/80 rounded-2xl space-y-3">
                ...
                <div class="divide-y divide-slate-200/60 dark:divide-slate-800 text-xs">
                    <?php $__empty_1 = true; $__currentLoopData = $topTrainings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="py-2.5 flex items-center justify-between gap-4">
                            <span class="font-medium text-slate-850 dark:text-slate-200 truncate" title="<?php echo e($tr->title); ?>"><?php echo e($tr->title); ?></span>
                            <span class="font-bold text-slate-500 shrink-0"><?php echo e($tr->views_count); ?> views</span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <span class="text-slate-400 block pt-2">Sem registo</span>
                    <?php endif; ?>
            ...
            <div class="bg-slate-50 dark:bg-slate-850 p-5 border border-slate-100 dark:border-slate-800/80 rounded-2xl space-y-3">
                ...
                <div class="divide-y divide-slate-200/60 dark:divide-slate-800 text-xs">
                    <?php $__empty_1 = true; $__currentLoopData = $popularSearches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $search): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="py-2.5 flex items-center justify-between gap-4">
                            <span class="font-medium text-slate-850 dark:text-slate-200 truncate" title="<?php echo e($search->query); ?>">"<?php echo e($search->query); ?>"</span>
                            <span class="font-bold text-slate-500 shrink-0"><?php echo e($search->hits); ?> buscas</span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/utilizador/Desktop/BUILDINS/angomarketers/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>